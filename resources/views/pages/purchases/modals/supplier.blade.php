<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            <h3 class="modal-title">Data Penyuplai</h3>
            <!--begin::Close-->
        ...
        <div class="modal-body">
            ...
            <table id="supplier_table" class="table table-bordered table-striped dataTable dtr-inline collapsed">
                <thead>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var table = $("#supplier_table").DataTable({
                ...
                "ajax": {
                    "url": "{{ route('purchase.showSuppliersModalData') }}",
                    "type": "POST",
                    "data": function(d) {
                        d._token = "{{ csrf_token() }}";
                ...
                "columns": [{
                    ...
                    },
                    {
                        ...
                        "render": function(data, type, full, meta) {
                            return `<button type='button' class='btn btn-sm btn-primary' onclick='selectSupplier(
                            "${full.id}",
                            "${full.name}"
                            )'>Pilih</button>`;
                        }
