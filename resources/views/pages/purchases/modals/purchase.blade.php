...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <form action="{{ route('purchase.storePurchase') }}" method="POST" id="store_purchase" accept-charset="utf-8">
            @csrf
            <div class="modal-body">
                <input type="hidden" name="invoice_code" value="{{ $invoice_code ?? '' }}" id="invoice_code">
                <input type="hidden" name="supplier" value="{{ $customer ?? '' }}">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#store_purchase').submit(function(e) {
            e.preventDefault();
